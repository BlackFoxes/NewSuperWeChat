...
public class SettingsActivity extends BaseActivity implements OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		DisplayUtils.initBackWithTitle(this,getResources().getString(R.string.set));
...
//						FuLiCenterApplication.getInstance().getGroupAvatarMap().clear();
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        if(((MainActivity)mContext).isConflict){
        	outState.putBoolean("isConflict", true);
        }else if(((MainActivity)mContext).getCurrentAccountRemoved()){
