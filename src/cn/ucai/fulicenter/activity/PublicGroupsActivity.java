...
public class PublicGroupsActivity extends BaseActivity {
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            for (EMGroupInfo g : returnGroups) {
                                if (!FuLiCenterApplication.getInstance().getGroupAvatarMap().containsKey(g.getGroupId())) {
                                    groupsList.add(g);
	...
	private class GroupsAdapter extends ArrayAdapter<EMGroupInfo> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
            ...
            UserUtils.setAppGroupAvatar(PublicGroupsActivity.this,getItem(position).getGroupId(), (ImageView) convertView.findViewById(R.id.avatar));
